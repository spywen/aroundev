...
# Temps de génération: 2015-02-06 20:09:36 +0000
# ************************************************************
...
CREATE TABLE `event` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_j4t2r4hrdkdiih5dwcsomrcs5` (`owner`),
  CONSTRAINT `FK_j4t2r4hrdkdiih5dwcsomrcs5` FOREIGN KEY (`owner`) REFERENCES `user` (`id`)
...
CREATE TABLE `user` (
  ...
  `publicname` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `user` (`id`, `email`, `firstname`, `isactive`, `isfemale`, `lastname`, `password`, `registerdate`, `publicname`)
VALUES
	(1,'spywen@hotmail.fr','babin',00000001,00000000,'laurent','e73b79a0b10f8cdb6ac7dbe4c0a5e25776e1148784b86cf98f7d6719d472af69','0000-00-00 00:00:00',''),
	(2,'k@k.com','fontaine',00000001,00000001,'camille','e73b79a0b10f8cdb6ac7dbe4c0a5e25776e1148784b86cf98f7d6719d472af69','0000-00-00 00:00:00','');
