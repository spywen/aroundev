...
.service('authService',["$translate", "$http", "$location", "Restangular", "$q", "user", "toastr", function($translate, $http, $location, Restangular, $q, user, toastr){
...
.controller('loginCtrl', ["$translate", "$scope", "authService", "$interval", "$location", "$rootScope", "localConfig", "toastr", function($translate, $scope, authService, $interval, $location, $rootScope, localConfig, toastr) {
