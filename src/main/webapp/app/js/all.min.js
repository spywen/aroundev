...
.run(["authService", "$location", "$rootScope", "$state", function(authService, $location, $rootScope, $state){
...
.service('authService',["$translate", "$http", "$location", "Restangular", "$q", "toastr", "utilsService", function($translate, $http, $location, Restangular, $q, toastr, utilsService){
...
.directive('menu',["authService", function(authService){
    return {
        scope: true,
...
.controller('signinCtrl',["$scope", "authService", "toastr", "$translate", "$state", function($scope, authService, toastr, $translate, $state){
...
}).directive('loginValidation', ["authService", "toastr", "$translate", "$q", function(authService, toastr, $translate, $q) {
    return {
        require: 'ngModel',
        link: function(scope, elm, attrs, ctrl) {
...
}]).directive('supinfoIdValidation', ["authService", "toastr", "$translate", "$q", function(authService, toastr, $translate, $q) {
    return {
        require: 'ngModel',
        link: function(scope, elm, attrs, ctrl) {
...
}]).directive('integerValidation', ["authService", "toastr", "$translate", "$q", function(authService, toastr, $translate, $q) {
    return {
        require: 'ngModel',
        link: function(scope, elm, attrs, ctrl) {
...
}]).directive('emailValidation', ["authService", "toastr", "$translate", "$q", function(authService, toastr, $translate, $q) {
    return {
        require: 'ngModel',
        link: function(scope, elm, attrs, ctrl) {
