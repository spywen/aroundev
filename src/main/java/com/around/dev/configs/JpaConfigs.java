...
public class JpaConfigs {
    ...
    private static final String DEFAULT_ENTITYMANAGER_PACKAGES_TO_SCAN = "com.around.dev.entity";
    ...
    public static final String DEFAULT_EMBEDDED_DATABASE_NAME = "aroundev";
